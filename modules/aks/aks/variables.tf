...
variable "vnet_subnet" {
  type        = string
  default     = null
  description = "The name of the existing Subnet within the Virtual Network which should be used for this Kubernetes Cluster. If this is specified, `var.vnet_name` must also be specified."
}

variable "vnet_name" {
  type        = string
  default     = null
  description = "The name of an existing Virtual Network which should be used for this Kubernetes Cluster. If this is specified, `var.vnet_subnet_name` must also be specified."
}
