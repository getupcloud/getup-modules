...
## VPC CNI
variable "vpc_cni_custom_network_cfg" {
  description = "Enables custom networking for the VPC CNI. Reference docs https://docs.aws.amazon.com/eks/latest/userguide/cni-custom-network.html."
  type        = bool
  default     = true
}
