# File auto-generated by command: ./bin/make-example main eks eks v2.2.5

module "eks" {
  source = "git@github.com:getupcloud/getup-modules//modules/eks/eks?ref=v2.2.5"
  ...
  vpc_cni_custom_network_cfg               = var.vpc_cni_custom_network_cfg
  vpc_cni_enable_prefix_delegation         = var.vpc_cni_enable_prefix_delegation
  kube_proxy                               = var.kube_proxy
  fargate_profiles                         = var.fargate_profiles
  fargate_private_subnet_ids               = var.fargate_private_subnet_ids
  fallback_node_group_private_subnet_ids   = var.fallback_node_group_private_subnet_ids
  ...
  karpenter_node_pool_disruption           = var.karpenter_node_pool_disruption
  karpenter_node_pool_taints               = var.karpenter_node_pool_taints
