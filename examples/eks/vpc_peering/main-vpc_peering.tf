# File auto-generated by command: ./bin/make-example main eks vpc_peering v2.2.1

module "vpc_peering" {
  source = "git@github.com:getupcloud/getup-modules//modules/eks/vpc_peering?ref=v2.2.1"
