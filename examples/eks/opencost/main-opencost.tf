# File auto-generated by command: ./bin/make-example main eks opencost v2.0.5

module "opencost" {
  source = "git@github.com:getupcloud/getup-modules//modules/eks/opencost?ref=v2.0.5"
