# File auto-generated by command: ./bin/make-example main eks external-dns v2.0.15

module "external-dns" {
  source = "git@github.com:getupcloud/getup-modules//modules/eks/external-dns?ref=v2.0.15"
