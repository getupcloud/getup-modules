# File auto-generated by command: ./bin/make-example main eks external-dns v2.2.2

module "external-dns" {
  source = "git@github.com:getupcloud/getup-modules//modules/eks/external-dns?ref=v2.2.2"
