...
module "flux" {
  source = "github.com/getupcloud/terraform-modules//modules/flux?ref=v0.2.0"

  flux_aws_region                         = var.flux_aws_region
  flux_cluster_name                       = var.flux_cluster_name
  flux_cluster_certificate_authority_data = var.flux_cluster_certificate_authority_data
